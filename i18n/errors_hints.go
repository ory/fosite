...
const (
	...
	ErrHintInvalidPKCECodeChallengeMethodPlainNotAllowed ErrorHintType = "invalid_pkce_code_challenge_method_plain_not_allowed"
	...
	ErrHintHandlerInvalidClientAssertionAudience   ErrorHintType = "invalid_handler_client_assertion_aud"
...
var (
	HintsMap = map[ErrorHintType]string{
		...
		ErrHintHandlerInvalidClientAssertionAudience:         "The JWT in \"assertion\" request parameter MUST contain an \"aud\" (audience) claim containing a value \"%s\" that identifies the authorization server as an intended audience.",
		...
		ErrHintInvalidPKCECodeChallengeMethod:                "The code_challenge_method is not supported, use %s instead.",
		ErrHintInvalidPKCECodeChallengeMethodPlainNotAllowed: "Clients must use code_challenge_method=%s, plain is not allowed.",
