...
do this is via
[ORY Fosite Discussions](https://github.com/ory/Fosite/discussions) or
...
- **Give us a star.** It may not seem like much, but it really makes a
  ...
  Fosite. Github stars help the project gain visibility and stand out.
...
Check out
[ORY Fosite Discussions](https://github.com/ory/Fosite/discussions).
...
[docs](https://github.com/ory/Fosite/tree/master/docs) folder. Generate API
...
git clone git@github.com:ory/Fosite.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/Fosite.git
