...
const (
	...
	BearerAccessToken AccessTokenType = "bearer"
	MacAccessToken    AccessTokenType = "mac"
)
...
type OAuth2Provider interface {
	...
	IntrospectToken(ctx context.Context, token string, tokenType TokenType, session Session, scope ...string) (TokenType, AccessTokenType, AccessRequester, error)
...
type IntrospectionResponder interface {
	...
	// GetTokenType optionally returns the type of the token that was introspected. This could be "access_token", "refresh_token",
