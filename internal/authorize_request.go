...
func (m *MockAuthorizeRequester) GetCodeChallenge() string {
	ret := m.ctrl.Call(m, "GetCodeChallenge")
	ret0, _ := ret[0].(string)
	return ret0
}

// GetCodeChallenge indicates an expected call of GetCodeChallenge
func (mr *MockAuthorizeRequesterMockRecorder) GetCodeChallenge() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCodeChallenge", reflect.TypeOf((*MockAuthorizeRequester)(nil).GetCodeChallenge))
}

// GetCodeChallengeMethod mocks base method
func (m *MockAuthorizeRequester) GetCodeChallengeMethod() string {
	ret := m.ctrl.Call(m, "GetCodeChallengeMethod")
	ret0, _ := ret[0].(string)
	return ret0
}

// GetCodeChallengeMethod indicates an expected call of GetCodeChallengeMethod
func (mr *MockAuthorizeRequesterMockRecorder) GetCodeChallengeMethod() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCodeChallengeMethod", reflect.TypeOf((*MockAuthorizeRequester)(nil).GetCodeChallengeMethod))
}
