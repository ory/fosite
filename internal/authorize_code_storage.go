...
func (_m *MockAuthorizeCodeStorage) CreateAuthorizeCodeSession(_param0 context.Context, _param1 string, _param2 fosite.Requester) (context.Context, error) {
...
func (_m *MockAuthorizeCodeStorage) DeleteAuthorizeCodeSession(_param0 context.Context, _param1 string) (context.Context, error) {
...
func (_m *MockAuthorizeCodeStorage) GetAuthorizeCodeSession(_param0 context.Context, _param1 string, _param2 interface{}) (context.Context, fosite.Requester, error) {
