...
// DeleteAuthorizeCodeSession mocks base method
func (m *MockAuthorizeCodeStorage) DeleteAuthorizeCodeSession(arg0 context.Context, arg1 string) error {
	ret := m.ctrl.Call(m, "DeleteAuthorizeCodeSession", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteAuthorizeCodeSession indicates an expected call of DeleteAuthorizeCodeSession
func (mr *MockAuthorizeCodeStorageMockRecorder) DeleteAuthorizeCodeSession(arg0, arg1 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteAuthorizeCodeSession", reflect.TypeOf((*MockAuthorizeCodeStorage)(nil).DeleteAuthorizeCodeSession), arg0, arg1)
}
