...
func (_m *MockTokenEndpointHandler) HandleTokenEndpointRequest(_param0 context.Context, _param1 fosite.AccessRequester, _param2 *http.Request, _param3 interface{}) error {
...
func (_m *MockTokenEndpointHandler) HandleTokenEndpointResponse(_param0 context.Context, _param1 fosite.AccessResponder, _param2 fosite.AccessRequester, _param3 *http.Request, _param4 interface{}) error {
