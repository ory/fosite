...
func (m *MockCoreStorage) DeleteAuthorizeCodeSession(arg0 context.Context, arg1 string) error {
...
func (mr *MockCoreStorageMockRecorder) DeleteAuthorizeCodeSession(arg0, arg1 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteAuthorizeCodeSession", reflect.TypeOf((*MockCoreStorage)(nil).DeleteAuthorizeCodeSession), arg0, arg1)
}
