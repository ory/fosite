...
func (_m *MockAuthorizeResponder) AddHeader(key string, value string) {
...
func (_m *MockAuthorizeResponder) AddQuery(key string, value string) {
	_m.ctrl.Call(_m, "AddQuery", key, value)
}
...
func (_m *MockAuthorizeResponder) AddFragment(key string, value string) {
	_m.ctrl.Call(_m, "AddFragment", key, value)
}
