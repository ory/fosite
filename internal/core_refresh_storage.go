...
func (_m *MockRefreshTokenGrantStorage) CreateAccessTokenSession(_param0 string, _param1 fosite.AccessRequester) error {
...
func (_m *MockRefreshTokenGrantStorage) CreateRefreshTokenSession(_param0 string, _param1 fosite.AccessRequester) error {
...
func (_m *MockRefreshTokenGrantStorage) GetAccessTokenSession(_param0 string) (fosite.AccessRequester, error) {
...
func (_mr *_MockRefreshTokenGrantStorageRecorder) GetAccessTokenSession(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "GetAccessTokenSession", arg0)
}

func (_m *MockRefreshTokenGrantStorage) GetRefreshTokenSession(_param0 string) (fosite.AccessRequester, error) {
...
func (_mr *_MockRefreshTokenGrantStorageRecorder) GetRefreshTokenSession(arg0 interface{}) *gomock.Call {
